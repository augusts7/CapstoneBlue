...
class Slots extends React.Component {
  ...
  render() {
    ...
    let slotsStyle = { "overflow-y": "scroll", "height": window.innerHeight * 0.9 };
      ...
      let fields = [
          { "name": "empty", "label": "Empty or Occupied", "type": "select", "required": true, "options": [{ "name": "Empty", "value": "empty" }, { "name": "Occupied", "value": "occupied" }] },
              ...
              <div className="mdl-cell--4-col">
                  <div className="slotsTitle">
                      ...
                      <div className="slotsTitleButton">
                          <Link to="/addAdvisingSlots"><Button role="primary"><i className="material-icons">add</i>Create New Slots</Button></Link>
                      </div>
                  </div>
