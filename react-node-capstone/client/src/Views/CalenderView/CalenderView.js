  ...
  singleEventHtml(data) {
    ...
    buttons.push(
      <div style={{ display: "inline-block" }}>
        <MaterialButton
          key="1"
          style={{ padding: "2px", backgroundColor: "#455A64", color: "white" }}
          onClick={this.props.onAddToCalendar}
        >
          Delete
        </MaterialButton>
      </div>
      ...
      <div className="slotRoot" key={data.key}>
        <div className="mdl-grid">
          ...
          <div className="mdl-cell--10-col">
            <div className="mdl-color-text--blue-900">{date}</div>
            ...
            <div style={{ paddingTop: "8px" }}>{buttons}</div>
          </div>
        </div>
      </div>
    );
        ...
        <div className="calendarViewContainer">
          ...
          <div>
            <div className="calendarView_side_card">
              ...
              <div style={smallCardStyle} className="styleScroll"></div>
            </div>
