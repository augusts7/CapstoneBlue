...
export default class CalendarFilter extends React.Component {
    ...
    constructor(props) {
        ...
        this.state = {
            "cals": [{ "calendarName": "Dummy data", "calendarId": "dummyId" }, { "calendarName": "Another Dummy", "calendarId": "dummy id aother" }],
            "menuAnchor": null,
            "openShare": false,
            "openAdd": false,
            "sharedCalId": null,
    ...
    loadCalendars = () => {
        ...
        get("calendar/sharedToUser", (res) => {
            ...
            var cals = [];
            cals.push({ "calendarName": "Dummy data", "calendarId": "dummyId" });
            cals.push({ "calendarName": "Another Dummy", "calendarId": "dummyId2" });
        ...
        return (
            <ExpansionPanel>
                ...
                <ExpansionPanelActions>
                    ...
                    <Button size="small" onClick={() => this.loadCalendars()}>Close</Button>
