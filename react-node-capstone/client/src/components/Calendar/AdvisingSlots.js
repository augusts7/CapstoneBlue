        ...
        const availableSlots = this.state.slots.map(function (item, i) {
            ...
            return (
                <li key={i} className="availableSlots">
                    {item.start.substring(6, 8)}{item.start.substring(8, 10)}-{item.start.substring(0, 4)} {item.start.substring(11, 16)} to {item.end.substring(6, 8)}
                    {item.end.substring(8, 10)}-{item.end.substring(0, 4)} {item.end.substring(11,16)}
                </li>
            );
        });
            ...
            function (item, i) {
                return (
                    <li key={i} className="availableSlots">
                        {" "}
                        {item.start.substring(6, 8)}{item.start.substring(8, 10)}-{item.start.substring(0, 4)} {item.start.substring(11, 16)} to {item.end.substring(6, 8)}
                        {item.end.substring(8, 10)}-{item.end.substring(0, 4)} {item.end.substring(11,16)} with {item.advisor}
