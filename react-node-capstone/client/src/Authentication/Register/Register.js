...
class Register extends React.Component {
    ...
    render() {
        ...
        let fields = [
            ...
            { "name": "user_type", "type": "select", "label": "User Type", "require": true, "onChange": this.handleChangeInUserType, "options": [{ "name": "Student", "value": "student" }, { "name": "Faculty", "value": "faculty" }] },
        ...
        if (this.state.user_type == "student") {
            fields = [
                ...
                { "name": "advisor", "type": "select", "label": "Select Advisor", "require": true, "options": this.state.advisors },
        ...
        return (
            <div className="mdl-grid" style={{ "width": "100%" }}>
                <div className="mdl-cell--6-col mdl-cell--12-col-phone mdl-cell--10-col-tablet mdl-color--white mdl-shadow--4dp center">
                    <div>
                        ...
                        <Form customSubmitButton={true} id={id} icon={icon} onSubmit={this.onSubmit} title={title} fields={fields}>
                            ...
                            <div>
                                <Button role="main" type="submit" style={{ "margin-top": "16px", "padding-left": "16px", "padding-right": "32px" }}><i className="material-icons">add</i>Create new Account</Button>
                            </div>
                        </Form>
                    </div>
                    <div className="mdl-shadow--4dp" style={{ "border": "0.5px solid #1976D2", "background-color": "#1565C0", "color": "white", "padding": "24px 8px 8px 8px", "margin": "16px 0px 0px 0px" }}>
                        <div style={{ "display": "flex", "justify-content": "center", "margin-bottom": "16px" }}>Already have an Account? Sign in</div>
                        <div style={{ "display": "flex", "justify-content": "center" }}>
                            <Link to="/login">
                                <Button role="primary" style={{ "padding-left": "16px", "padding-right": "32px" }}><i className="material-icons">accessibility</i>Sign In</Button>
                            </Link>
                        </div>
                    </div>
                </div>
