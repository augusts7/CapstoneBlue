    ...
    render() {
        ...
        return (
            <div className="mdl-grid" style={{"width": "100%"}}>
                <div
                    className="mdl-cell--6-col mdl-cell--10-col-phone mdl-cell--10-col-tablet mdl-color--white mdl-shadow--4dp center">
                    ...
                    <Form customSubmitButton={true} id={id} icon={icon} onSubmit={this.onSubmit} title={title}
                        ...
                        <div>
                            <Button type="submit"
                                ...
                                className="material-icons">email</i>Send Password reset email</Button>
                        </div>
                    ...
                    <div className="mdl-shadow--4dp" style={{
                        ...
                        <div style={{"display": "flex", "justify-content": "center", "margin-bottom": "16px"}}>Sign in
                            Instead?
                        </div>
                        <div style={{"display": "flex", "justify-content": "center"}}>
                            <Link to="/login">
                                <Button role="primary" style={{"padding-left": "816x", "padding-right": "32px"}}><i
